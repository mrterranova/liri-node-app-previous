...
* If using this application make sure to check out .gitignore 
...
* (therefore you will not see the following make sure to add these if you want to make this file)
``` 
node_modules
.DS_Store
.env
...
Also, in the video I added more to the random.txt file and ran the 'do-what-this-says' command. It will pull all information in random.txt and run. Please check out my video: https://vimeo.com/353225387 to see this in action! It's located at 5:50 on the video!
